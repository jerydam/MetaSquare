...
export default function Documentation() {
    return(
        <div >
            ...
            <div>
            <h1 className="text-3xl font-bold">How to Create an Event</h1>
            </div>

            <div>
                <ol>
                    <li><span className="text-xl font-semibold">Register the event</span> 
                    ...
                    <li><span className="text-xl font-semibold">Create the Event</span>
                    ...
                    <li> <span className="text-xl font-semibold">Set attendees</span>
                    ...
                    <li><span className="text-xl font-semibold">Register for event</span>
                    ...
                    <li><span className="text-xl font-semibold">Claim Certificate of attendance</span>
